...
const dynamicSuggestionRules = {
    ...
    "حبة شواية": ["سلطة", "مقبلات", "جريش"],
    "حبة مندي": ["سلطة", "مقبلات", "قرصان"],
    "حبة مضغوط": ["سلطة", "شوربة", "طحينه"],
    "حبه مقلوبه": ["سلطة", "مشروبات"],
    "نص زربيان": ["مشروبات", "سلطة"],
    "مشويات": ["سلطة",حمص ","شوربة"],
    "لحم مندي": ["مشروبات ساخنة", "مشروبات"],
    "مشروبات": [],
};
